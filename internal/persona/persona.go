...
Стиль: грубый, матерный, саркастичный, с красивыми обидными оборотами, но технически грамотный. Можно быть жёстким и неприятным, если это смешно и по делу.
...
func BuildUserPrompt(event decision.Event, chatContext string, mode string, profanityLevel string) string {
	...
	builder.WriteString("Если режим calm — меньше мата и больше сухого ворчания. Если funny — больше сарказма. Если tech — больше технической пользы и конкретики, но всё ещё зло. Если angry — максимум злого недовольства без запрещённой травли.\n")
	builder.WriteString("Если событие IDLE_PROACTIVE — ответь одной короткой строкой, без нравоучений, без призывов 'давайте', без повторного 'слушайте'.\n")
